...
if __name__ == '__main__':
    ...
    text_file = os.path.join(in_path, 'text')
    ...
    try:
        ...
        encoder = file_parse.detectEncoding(text_file)
        text_reader = codecs.open(text_file, 'r', encoding=encoder)
    ...
    out_text_file = os.path.join(train_path, 'text')
    ...
    for i in train_utt_idx:
        ...
        text_utt_id, text_value = text_dict[i]
        spk_utt_id, spk_id = utt2spk_dict[i]
        data_utt_id, data_id = utt2data_dict[i]
        
        if text_utt_id == utt_id and spk_utt_id == utt_id and data_utt_id == utt_id:
    ...
    out_text_file = os.path.join(dev_path, 'text')
    ...
    out_text_file = os.path.join(test_path, 'text')
