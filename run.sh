...
CUDA_VISIBLE_DEVICES=2,3 /home/snie/anaconda3/envs/pan/bin/python3 -m torch.distributed.launch --nproc_per_node=2 train_speaker.py --dist-url "tcp://127.0.0.1:15502" --delta_order 0 --agument_feat --normalize_type 0 --batch_size 128 --rnn_hidden_size 256 --embedding_size 512 --cuda --batch_size 128 --dataroot /exdata/HOME/snie/dataset/speaker/AISHELL-2/iOS --loss_type "class_softmax" --margin_type "Softmax" --att_type $att_type --model_type "multi_attention" --segment_type "all" --speaker_num 32 --utter_num 8 --resume "none" --lr 0.002 --optim_type "adam" --segment_shift_rate 0.50 --min_segment_length 240 --max_segment_length 280 --min_num_segment 5 --max_num_segment 15